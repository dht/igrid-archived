import { Content, Wrapper } from './Instance.style';
...
export function Instance(_props: InstanceProps) {
  ...
  function renderInner() {
    return (
      <Wrapper className={className} style={styleContainer} ref={ref}>
        {!hideHeader && (
          <InstanceHeader
        ...
        <Content className={classNameContent} style={styleWidget}>
          {renderWidget()}
        </Content>
      </Wrapper>
    );
